...
```bash
curl -fsSL https://raw.githubusercontent.com/joejoey2026king-star/minecraft-panel/refs/heads/main/install.sh | sudo PANEL_DOMAIN=kingtech-erwan.fun PANEL_EMAIL=erwan@gmail.com bash
```
