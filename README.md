...
```bash
curl -fsSL https://raw.githubusercontent.com/joejoey2026king-star/minecraft-panel/refs/heads/main/install.sh | sudo PANEL_DOMAIN=panel.example.com PANEL_EMAIL=you@example.com bash
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/joejoey2026king-star/minecraft-panel/refs/heads/main/install.sh | sudo PANEL_IP_HTTPS=1 PANEL_EMAIL=you@example.com bash
```
